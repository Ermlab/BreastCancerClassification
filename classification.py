...
plt.savefig('pcavariancewithstd.png')
...
def plot_decision_tree1(a,b):
    dot_data = tree.export_graphviz(a, out_file='tree.dot',
                             feature_names=b,
...
cm_plot.figure.savefig('confusionmatrix.png')
#plt.show()
...
corr_plot.figure.savefig('corrmap.png')
#plt.show()